...
Javascript was utilised to create game interactivity which greatly increases satisfaction and a great user experience. Javascript was refactored and tested throughout the site build and more extensively at the end to aid DRY coding and enable easy future maintenance.
